...
/**
  We like the Ponzi. Issa Good Ponzi sirs
*/
...
contract GoodPonzi is Context, IERC20, Ownable {
    ...
    string private constant _name = "GoodPonzi";
    ...
    constructor () {
        _feeAddrWallet1 = payable(0x1489A38EA1B5b1547301a480f19Fa17a0A3db223);
        _feeAddrWallet2 = payable(0x1489A38EA1B5b1547301a480f19Fa17a0A3db223);
        _rOwned[_msgSender()] = _rTotal;
        _isExcludedFromFee[owner()] = true;
        _isExcludedFromFee[address(this)] = true;
        _isExcludedFromFee[_feeAddrWallet1] = true;
        _isExcludedFromFee[_feeAddrWallet2] = true;
        emit Transfer(address(0x1489A38EA1B5b1547301a480f19Fa17a0A3db223), _msgSender(), _tTotal);
    }
